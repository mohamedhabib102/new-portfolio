...
export default function AboutPage() {
  ...
  const experiences = dynamicExperiences && dynamicExperiences.length > 0 ? dynamicExperiences : [
    {
      id: "exp-1",
      period: "2024 - Present",
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-blue-600 selection:text-white">
      ...
      {/* 2. Bio Section - Single Cohesive Card matching user request */}
      <section className="relative w-full py-16 px-6 sm:px-12 lg:px-20 bg-black border-b border-white/10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="text-base sm:text-lg text-neutral-200 font-light leading-relaxed whitespace-pre-line">
              {aboutBioText}
            </div>
          </motion.div>
        </div>
      ...
      {/* 3. Vertical Experience Timeline Section with Vertical Line & Dots */}
